...
local default_on_attach = function(client, bufnr)
	...
	buf_set_keymap(bufnr, "n", "gy", "<cmd>lua require('telescope.builtin').lsp_type_definitions()<cr>", opts)
	buf_set_keymap(bufnr, "n", "K", "<cmd>lua vim.lsp.buf.hover()<CR>", opts)
	buf_set_keymap(bufnr, "n", "<space>l", "<cmd>lua require('telescope.builtin').lsp_implementations()<CR>", opts)
	buf_set_keymap(bufnr, "i", "<C-l>", "<cmd>lua vim.lsp.buf.signature_help()<CR>", opts)
	...
	buf_set_keymap(bufnr, "n", "<space>q", "<cmd>lua vim.diagnostic.setqflist({ open = false })<CR>", opts)
	buf_set_keymap(bufnr, "n", "<space>f", "<cmd>lua vim.lsp.buf.format()<CR>", opts)
	buf_set_keymap(bufnr, "n", "<space>i", "<cmd>lua require('telescope.builtin').lsp_incoming_calls()<CR>", opts)
	buf_set_keymap(bufnr, "n", "<space>o", "<cmd>lua require('telescope.builtin').lsp_outgoing_calls()<CR>", opts)
	buf_set_keymap(bufnr, "n", "<space>ss", "<cmd>lua require('telescope.builtin').lsp_document_symbols()<cr>", opts)
	buf_set_keymap(bufnr, "n", "<space>sw", "<cmd>lua require('telescope.builtin').lsp_workspace_symbols()<cr>", opts)
	buf_set_keymap(bufnr, "n", "<space>sd", "<cmd>lua require('telescope.builtin').lsp_dynamic_workspace_symbols()<cr>", opts)
...
local servers_with_default_config = { "pyright", "eslint", "terraformls", "ansiblels", "texlab" }
