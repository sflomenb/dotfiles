...
"                \ :call <SID>StripTrailingWhitespaces()
	...
	autocmd FileType java nnoremap <M-l> yiwoSystem.out.println()<Esc>F(a'<Esc>pa: ' + <Esc>p
	autocmd FileType java vnoremap <M-l> yoSystem.out.println()<Esc>F(a'<Esc>pa: ' + <Esc>p
