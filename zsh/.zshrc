...
PROMPT='${MODE_INDICATOR_PROMPT}%(?..$fg[red]%? )$(is_nix)$fg[green]%n$fg[magenta]@$fg[cyan]%m%{$reset_color%}: %$(myPromptWidth)<..<%~%<< %W %t $fg[green]$(git_branch) %{$reset_color%}
%# '
